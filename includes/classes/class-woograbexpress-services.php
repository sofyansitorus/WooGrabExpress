 ...
 */
abstract class WooGrabExpress_Services {
	...
	public function get_description() {
		...
		return sprintf( __( '<a href="%s" target="_blank">Click here</a> for more info about GrabExpress.', 'woograbexpress' ), 'https://www.grab.com/id/en/express/' );
	}
	...
	public function get_fields_raw() {
		return array(
			'enable'              => array(
				'title'       => __( 'Enable', 'woograbexpress' ),
				'label'       => __( 'Yes', 'woograbexpress' ),
				'type'        => 'woograbexpress',
				'orig_type'   => 'checkbox',
				'description' => __( 'Enable delivery service.', 'woograbexpress' ),
				'desc_tip'    => true,
				'class'       => 'woograbexpress-toggle-service',
			),
			'title'               => array(
				'title'       => __( 'Label', 'woograbexpress' ),
				'type'        => 'woograbexpress',
				'orig_type'   => 'text',
			...
			'min_cost'            => array(
				...
				'type'              => 'woograbexpress',
				'orig_type'         => 'price',
				'description'       => __( 'Minimum shipping cost that will be billed to customer. Set to zero to disable.', 'woograbexpress' ),
				'desc_tip'          => true,
				'is_required'       => true,
			...
			'max_cost'            => array(
				...
				'type'              => 'woograbexpress',
				'orig_type'         => 'price',
				'description'       => __( 'Maximum shipping cost that will be billed to customer. Set to zero to disable.', 'woograbexpress' ),
				'desc_tip'          => true,
				'is_required'       => true,
				'custom_attributes' => array(
					'min'  => '0',
			...
			'per_km_cost'         => array(
				'title'             => __( 'Per Kilometer Cost', 'woograbexpress' ),
				'type'              => 'woograbexpress',
				'orig_type'         => 'price',
				'description'       => __( 'Per kilometer rates that will be billed to customer. Set to zero to disable.', 'woograbexpress' ),
				'desc_tip'          => true,
				'is_required'       => true,
				'custom_attributes' => array(
					'min'  => '0',
			...
			'per_km_min_distance' => array(
				'title'             => __( 'Per Kilometer Cost Minimum Distance', 'woograbexpress' ),
				'type'              => 'woograbexpress',
				'orig_type'         => 'number',
				'description'       => __( 'Minimum distance required to charge the per kilometer cost.', 'woograbexpress' ),
				'desc_tip'          => true,
				'is_required'       => true,
				'custom_attributes' => array(
					'min'       => '0',
			...
			'max_weight'          => array(
				...
				'type'              => 'woograbexpress',
				'orig_type'         => 'number',
				'description'       => __( 'Maximum package weight in kilograms that will be allowed to use this service.', 'woograbexpress' ),
				'desc_tip'          => true,
				'is_required'       => true,
				'custom_attributes' => array(
					'min'       => '1',
			...
			'max_width'           => array(
				...
				'type'              => 'woograbexpress',
				'orig_type'         => 'number',
				'description'       => __( 'Maximum package size width in centimeters that will be allowed to use this service.', 'woograbexpress' ),
				'desc_tip'          => true,
				'is_required'       => true,
				'custom_attributes' => array(
					'min'       => '1',
			...
			'max_length'          => array(
				...
				'type'              => 'woograbexpress',
				'orig_type'         => 'number',
				'description'       => __( 'Maximum package size length in centimeters that will be allowed to use this service.', 'woograbexpress' ),
				'desc_tip'          => true,
				'is_required'       => true,
				'custom_attributes' => array(
					'min'       => '1',
			...
			'max_height'          => array(
				...
				'type'              => 'woograbexpress',
				'orig_type'         => 'number',
				'description'       => __( 'Maximum package size height in centimeters that will be allowed to use this service.', 'woograbexpress' ),
				'desc_tip'          => true,
				'is_required'       => true,
				'custom_attributes' => array(
					'min'       => '1',
			...
			'max_distance'        => array(
				...
				'type'              => 'woograbexpress',
				'orig_type'         => 'number',
				'description'       => __( 'Maximum distance in kilometers that will be allowed to use this service.', 'woograbexpress' ),
				'desc_tip'          => true,
				'is_required'       => true,
				'custom_attributes' => array(
					'min'       => '1',
			...
			'multiple_drivers'    => array(
				...
				'type'        => 'woograbexpress',
				'orig_type'   => 'checkbox',
				'description' => __( 'Split shipping into several drivers if the total package weight and dimensions exceeded the limit. Will be handy for bulk quantity orders.', 'woograbexpress' ),
				'desc_tip'    => true,
			),
		);
	}
	...
	public function calculate_cost( $distance, $envelope, $settings = array() ) {
		...
		if ( $max_distance && $distance > $max_distance ) {
			...
			return new WP_Error( 'max_distance_exceeded', sprintf( __( 'Shipping distance exceeded the maximum setting: %1$s', 'woograbexpress' ), $this->get_slug() ) );
		}
		...
		if ( ! $multiple_drivers ) {
			...
			if ( $envelope_weight > $max_weight ) {
				// translators: %1$s is service ID.
				return new WP_Error( 'max_weight_exceeded', sprintf( __( 'Package weight exceeded the maximum setting: %1$s', 'woograbexpress' ), $this->get_slug() ) );
			}

			// Validate package dimension.
			if ( $envelope_dimension > $max_dimension ) {
				// translators: %1$s is service ID.
				return new WP_Error( 'max_dimension_exceeded', sprintf( __( 'Package dimension exceeded the maximum setting: %1$s', 'woograbexpress' ), $this->get_slug() ) );
			}
		}
