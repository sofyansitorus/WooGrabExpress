(function ($) {
    ...
    var wooGrabExpress = {
        ...
        inputApiKeyId: 'woocommerce_woograbexpress_gmaps_api_key',
        inputLatId: 'woocommerce_woograbexpress_origin_lat',
        inputLngId: 'woocommerce_woograbexpress_origin_lng',
        mapWrapperId: 'woograbexpress-map-wrapper',
        mapSearchId: 'woograbexpress-map-search',
        mapCanvasId: 'woograbexpress-map-canvas',
        zoomLevel: 16,
        ...
        _buildMap: function () {
            ...
            var infowindow = new google.maps.InfoWindow({
                maxWidth: 350,
                content: woograbexpress_params.txt.drag_marker
            });
